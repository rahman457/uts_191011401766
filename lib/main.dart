...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text("Rachman Ardiansyah Harahap"),
        ),
      ),
      body: GridView.count(
        ...
        children: [
          ...
          CustomCard(title: "Judul Card Ketujuh", image: "https://cdn.pixabay.com/photo/2016/08/27/14/38/mountains-1624284__340.jpg.jpg"),
